...
function derivePointMaps(widthPoints, heightPoints) {
    const widthCount = widthPoints.length;
    const heightCount = heightPoints.height;
    const retVal = new Array(widthCount * heightCount);

    for (var ii = 0; ii < widthCount; ii++ ) {
        for (var jj = 0; jj < lengthCount; jj++ ) {
