...
import {CardRef} from './card_types';
   ...
   if (recordedResponse) {
      ...
      try {
         ...
         const matchData: MatchData = {
            ...
            enemy_guild_name,
            enemy_max_health,
            enemy_deck_count: attacker_deck_count,
            player_deck_count: defender_deck_count,
         };

         console.log('Extract: ', matchData);
         defend_deck = Object.values(defend_deck);
         card_map = Object.values(card_map)
            .slice(0, attacker_deck_count);

         const cardRefs: CardRef[] = defend_deck.concat(card_map) as CardRef[];
