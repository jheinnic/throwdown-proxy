...
import { AbstractModelSeedStrategy } from '../../../../../../modules/tickets/components/modelSeed';
import { IModelSeed } from '../../../../../../modules/randomArt/interface';
   ...
   launchPaintContent()
   {
      const incomingChan =
         this.concurrentWorkFactory.createTxChan(
            map<[Buffer, Buffer], Promise<IModelSeed>>(
