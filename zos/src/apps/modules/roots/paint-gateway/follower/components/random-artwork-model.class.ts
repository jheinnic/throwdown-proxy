...
import { IArtworkSeed, IncrementalPlotProgress, } from '../interface';
import {
   CANVAS_X_COORD,
   CANVAS_Y_COORD, IRandomArtworkModel, MappedPoint, MODEL_X_COORD, MODEL_Y_COORD
} from './interface';
...
export class RandomArtModel implements IRandomArtworkModel
{
   ...
   public constructor(public readonly modelSeed: IArtworkSeed)
   {
   ...
   */
    ...
    * range of mapped points, for spacing mapped points in units of pixelSize, and
