...
export const new_new_picture = methodHolder.new_new_picture;
export const new_picture = methodHolder.new_picture;
export const old_picture = methodHolder.old_picture;
export const compute_pixel = methodHolder.compute_pixel;
export const word_to_seed = methodHolder.word_to_seed;
export const partial_eval = methodHolder.partial_eval;
export const _eval = methodHolder.eval;
