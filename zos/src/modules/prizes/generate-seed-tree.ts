...
export function generateSeedTree(
   seedSource: Iterable<Buffer>, ticketCount: number, fileName: string)
{
   ...
   console.log(
      digestLevelsPerFullTree, digestLevelsPerStorageLevel, digestLevelsPerWriteLevel,
      directoryDepth);
   ...
   const retVal = zip(computeSeedBits, directoryCreateCount, writeOffsets, fromWriteGuard)
      .subscribe(
