...
import {Deployment, TicketMintingPolicy} from '../../../apps/oldConfig';

export class KeypairProvisioningAppDi implements ApplicationInstaller {
   constructor(
      @inject(APP_CONFIG_TYPES.Deployment) private readonly deployConfig: Deployment,
      @inject(APP_CONFIG_TYPES.TicketMintingPolicy) private readonly ticketMinting: TicketMintingPolicy,
