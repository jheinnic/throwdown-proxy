...
put(sourceSemaphore, 1 as Slot);
put(sourceSemaphore, 2 as Slot);
put(sourceSemaphore, 3 as Slot);
put(sourceSemaphore, 4 as Slot);
put(sourceSemaphore, 5 as Slot);
// put(sourceSemaphore, 6 as Slot);
// put(sourceSemaphore, 7 as Slot);
// put(sourceSemaphore, 8 as Slot);
// put(sourceSemaphore, 9 as Slot);
// put(sourceSemaphore, 10 as Slot);
