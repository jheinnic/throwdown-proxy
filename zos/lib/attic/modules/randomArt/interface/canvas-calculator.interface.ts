...
import {CanvasDimensions, RenderScale} from './locators';
...
export interface ICanvasCalculator
{
    ...
    */
   create(
      maxPointsPerSlice: number, canvasDimensions: CanvasDimensions,
      renderScale?: RenderScale): IncrementalPlotterFactory
}